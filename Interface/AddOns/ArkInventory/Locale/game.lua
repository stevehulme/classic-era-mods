...
L["CURRENCY_TRANSFER"] = CURRENCY_TRANSFER_TOGGLE_BUTTON_LABEL or true
...
L["ITEM_BINDING-1"] = UNKNOWN or true
...
-- blizzard values just to stop client differences from causing issues
L["BANKSLOTPURCHASE"] = BANKSLOTPURCHASE or true
L["BANKSLOTPURCHASE_LABEL"] = BANKSLOTPURCHASE_LABEL or true
L["COSTS_LABEL"] = COSTS_LABEL or true
L["REVERSE_CLEAN_UP_BAGS_TEXT"] = REVERSE_CLEAN_UP_BAGS_TEXT or true
L["REAGENTBANK_DEPOSIT"] = REAGENTBANK_DEPOSIT or true
L["REAGENTBANK_PURCHASE_TEXT"] = REAGENTBANK_PURCHASE_TEXT or true
L["ACCOUNT_BANK_LOCKED_PROMPT"] = ACCOUNT_BANK_LOCKED_PROMPT or true
L["ACCOUNT_BANK_TAB_PURCHASE_PROMPT"] = ACCOUNT_BANK_TAB_PURCHASE_PROMPT or true
L["ACCOUNT_BANK_DEPOSIT_BUTTON_LABEL"] = ACCOUNT_BANK_DEPOSIT_BUTTON_LABEL or true
L["BANK_DEPOSIT_INCLUDE_REAGENTS_CHECKBOX_LABEL"] = BANK_DEPOSIT_INCLUDE_REAGENTS_CHECKBOX_LABEL or true




-- bindings
L["WOW_TOOLTIP_ITEM_BIND_ON_USE"] = ITEM_BIND_ON_USE or true
L["WOW_TOOLTIP_ITEM_BIND_ON_EQUIP"] = ITEM_BIND_ON_EQUIP or true
L["WOW_TOOLTIP_ITEM_SOULBOUND"] = ITEM_SOULBOUND or true
L["WOW_TOOLTIP_ITEM_BIND_ON_PICKUP"] = ITEM_BIND_ON_PICKUP or true
L["WOW_TOOLTIP_ITEM_ACCOUNTBOUND"] = ITEM_ACCOUNTBOUND or true
L["WOW_TOOLTIP_ITEM_ACCOUNTBOUND_UNTIL_EQUIP"] = ITEM_ACCOUNTBOUND_UNTIL_EQUIP or true
L["WOW_TOOLTIP_ITEM_BIND_TO_ACCOUNT"] = ITEM_BIND_TO_ACCOUNT or true
L["WOW_TOOLTIP_ITEM_BIND_TO_BNETACCOUNT"] = ITEM_BIND_TO_BNETACCOUNT or true
L["WOW_TOOLTIP_ITEM_BNETACCOUNTBOUND"] = ITEM_BNETACCOUNTBOUND or true
...
L["WOW_TOOLTIP_ITEM_UNIQUE_MULTIPLE"] = FormatForCapture( "ITEM_UNIQUE_MULTIPLE" ) or true
