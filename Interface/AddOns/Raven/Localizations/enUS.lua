...
L["Hide default user interface for buffs."] = true
L["Hide default user interface for debuffs."] = true
L["Cast Bar"] = true
...
L["Hide default user interface for essence."] = true
...
L["If checked, test the player's essence."] = true
L["If checked, player's essence must be at least this many charges, otherwise must be less."] = true
